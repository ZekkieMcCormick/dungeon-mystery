...
var call_python_1 = require("C:/Coding/dungeon-mystery/src/evolution/call_python"); //MAKE THIS NOT ABSOLUTE
...
var pathLength = (0, ai_functions_1.aStarSearch)((0, dungeon_mystery_1.CreateMapString)(dungeon_map));
(0, call_python_1.callPythonScript)('evolution.py');
